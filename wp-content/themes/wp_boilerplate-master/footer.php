<footer class="" style="background-color: #cccccc;">
      ...
      <div class="container">
          ...
          <div class="row py-4 d-flex align-items-center">
              ...
              <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                   <h6 class="mb-0 text-white">Conectate a nuestras Redes Sociales!</h6>
              </div>
  ...
  <div class="container text-center text-md-left mt-5 text-dark">
    ...
    <!-- Copyright -->
   <div class="footer-copyright text-center py-3 bg-secondary text-dark">© 2018 Copyright:
       <a href=" " class="text-white"> tonerchile.cl</a>
   </div>
    <!-- Copyright -->
</footer>
...
<script src="jquery-3.3.1.min.js"></script>
 ...
 <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/lib/app.js"></script>
</body>
</html>