    ...
    <div class="container">
       <div class="row">
         ...
         <div class="col-md-6 p-4">
           <h3 class="text-danger">El mejor cartucho</h3>
           <p class="products-text pt-5">Toner alternativos importados, sellados de fabrica, no son remanufacturados, ni recargado, ni reciclado. 
           100% Garantizado.</p>
         </div>
       </div>
